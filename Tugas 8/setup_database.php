...
try {
    ...
    $pdo->exec("CREATE DATABASE IF NOT EXISTS toko_roti_db");
    echo "✓ Database 'toko_roti_db' created/verified\n";
    
    // Pilih database
    $pdo->exec("USE toko_roti_db");
    ...
    $pdo->exec($sql);
    echo "✓ Table 'produk' created/verified\n";
