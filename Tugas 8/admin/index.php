...
try {
    ...
    $total_nilai = array_sum(array_column($produk_list, 'harga'));
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        ...
                                        <h3 class="mb-0"><?= count($kategori_stats) ?></h3>
                                    </div>
                                    <div class="align-self-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small class="text-muted"><?= htmlspecialchars(substr($produk['deskripsi'], 0, 50)) ?>...</small>
                                        </td>
                                        <td>
                ...
                if (result.status === 'success') {
                    ...
                    document.getElementById('current_image').innerHTML = `
                        <div class="alert alert-info">
                            ...
                            <img src="../${produk.gambar}" class="img-fluid rounded mt-2" style="max-height: 100px;" 
